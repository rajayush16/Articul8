...
const AddBlog = () => {
  ...
  const aiTitleResponse = async () => {
    try {
      setAiTitle(true);
      const { data } = await axios.post<any>(`${author_service}/api/v1/ai/title`, {
        text: formData.title,
      });
  ...
  const aiBlogResponse = async () => {
    try {
      ...
      const { data } = await axios.post<any>(`${author_service}/api/v1/ai/blog`, {
      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <Label className="mb-2">Title <span className="text-pink-500">*</span></Label>
            ...
            <Label className="mb-2">Description <span className="text-pink-500">*</span></Label>
            <div className="flex justify-center items-center gap-2">
              <Input
                name="description"
